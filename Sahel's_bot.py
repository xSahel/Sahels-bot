...
#list des gif pour la commande eat
global gif
...
async def play(ctx):
	...
	if ingame == False:
		...
		await asyncio.sleep(1)
		await ctx.send("essaies de trouver le chiffre mystère compris entre 0 et 1000")	
		await asyncio.sleep(1)
		return
	else:
...
client.run("ODEzMTA5OTc2MTcxMDIwMjk4.YDKhrQ.vRpwoK_VzK3667rgxhgxvpA1Jts")